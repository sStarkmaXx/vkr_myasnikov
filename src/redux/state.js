    ...
    return (
        {
            catalog: [
                {
                    id: 1, url: "appliances", name: "Бытовая техника", items: [
                ...
                {
                    id: 2, url: "smartphones", name: "Смартфоны", items: [
                ...
                {
                    id: 4, url: "computers", name: "Компьютеры", items: [
                ...
                {
                    id: 5, url: "office", name: "Офис", items: [
                ...
                {
                    id: 6, url: "accessories", name: "Аксессуары", items: [
                ...
                {
                    id: 7, url: "cargoods", name: "Автотовары", items: [
                ...
                {
                    id: 8, url: "tools", name: "Инструменты", items: [
